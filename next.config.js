      ...
      },
      {
        ...
        headers: [
          ...
          // Content Security Policy — restrict script/style/image sources
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://pagead2.googlesyndication.com https://www.googletagmanager.com https://www.google-analytics.com https://*.clarity.ms https://pl31335206.profitableratecpmnetwork.com https://pl31335207.profitableratecpmnetwork.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://unpkg.com",
              "font-src 'self' https://fonts.gstatic.com",
              "img-src 'self' data: blob: https://hzgrzcablefquddisqkf.supabase.co https://images.unsplash.com https://lh3.googleusercontent.com https://vizhitn.in https://*.bing.com https://*.bing.net https://*.clarity.ms https://c.bing.com https://unpkg.com https://*.tile.openstreetmap.org https://*.tn.gov.in https://*.gov.in https://pl31335206.profitableratecpmnetwork.com https://pl31335207.profitableratecpmnetwork.com https://3nbf4.com",
              ...
              "frame-src 'self' https://pagead2.googlesyndication.com https://pl31335206.profitableratecpmnetwork.com https://pl31335207.profitableratecpmnetwork.com https://3nbf4.com",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
            ].join('; '),
