...
const nextConfig = {
  ...
  images: {
    ...
    remotePatterns: [
      ...
      { protocol: 'https', hostname: 'nammatn234234.in' },
        ...
        headers: [
          ...
          // Content Security Policy — restrict script/style/image sources
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://hzgrzcablefquddisqkf.supabase.co https://images.unsplash.com https://lh3.googleusercontent.com https://nammatn234234.in https://*.bing.com https://*.bing.net https://unpkg.com https://*.tile.openstreetmap.org https://*.tn.gov.in https://*.gov.in",
