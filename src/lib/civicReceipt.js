/**
 * NammaTN Civic Receipt utilities
 */

export const CIVIC_STATUSES = [
  {
    key: "reported",
    label: "Reported on NammaTN",
    label_ta: "NammaTN-ல் புகாரளிக்கப்பட்டது",
 ...
 */
export const makeTimelineEvent = (event, by = "NammaTN", event_type = "status_change", actor_type = "user") => ({
  event,
  event_type,
...
This issue was documented through NammaTN Civic Receipt ${post.civic_receipt_id || ""} on ${date}.

Kindly inspect and resolve this issue at the earliest. Photo proof is available on NammaTN platform.
