...
const SAMPLE_POSTS = [
  {
    ...
    assigned_department: "Greater Chennai Corporation (GCC)",
    upvotes: 24,
...
const POST_FORMAT_SCHEMA = [
  {
    ...
    "assigned_department": "string (Assigned Department Name)",
...
function normalisePost(raw, idx) {
  ...
  return {
    ...
    assigned_department: raw.assigned_department || raw.department_routing || raw.department || "",
    ...
    bribe_department: raw.bribe_department || (raw.post_type === "bribe" ? (raw.assigned_department || raw.department_routing || raw.department || "") : ""),
