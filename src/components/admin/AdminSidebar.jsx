...
import {
  ...
  Image, Megaphone, Flag, Settings, LogOut, Menu, X, ChevronRight, Shield, Zap, Globe, Users, Mail, Home, UserCheck
} from "lucide-react";
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-2.5 px-4 py-5 border-b border-slate-200">
        ...
        <div>
          <div className="font-bold text-slate-900 text-sm leading-tight">TN Voice</div>
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white border-b border-slate-200 flex items-center gap-3 px-4 py-3">
        ...
        <div className="font-bold text-slate-900 text-sm">TN Voice Admin</div>
      </div>
