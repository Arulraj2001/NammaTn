    ...
    <div className="border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden bg-white dark:bg-slate-900 shadow-sm">
      ...
      <div className="p-3 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-start sm:items-center gap-3 bg-slate-900/5 dark:bg-slate-950/40">
        ...
        {article.featured_image ? (
          <div className="relative w-full sm:w-44 h-24 rounded-lg overflow-hidden border border-slate-300 dark:border-slate-700 flex-shrink-0 bg-slate-900 group">
            ...
            <div className="absolute inset-0 bg-slate-950/75 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-1.5 backdrop-blur-xs">
              <button
                type="button"
                onClick={() => {
                  setSelectedImageFile(article.featured_image);
                  setCropModalOpen(true);
                }}
                className="px-2 py-1 rounded-md bg-blue-600 hover:bg-blue-700 text-white text-[10px] font-bold flex items-center gap-1 shadow transition-transform hover:scale-105"
                title="Re-crop / Adjust (16:9)"
              >
              ...
              <button
                ...
                className="px-2 py-1 rounded-md bg-slate-800 hover:bg-slate-700 text-white text-[10px] font-bold flex items-center gap-1 shadow border border-slate-600 transition-transform hover:scale-105"
          ...
          <button
            type="button"
            onClick={() => fileInputRef.current?.click()}
            className="relative w-full sm:w-44 h-24 rounded-lg overflow-hidden border-2 border-dashed border-slate-300 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-400 flex flex-col items-center justify-center text-slate-400 hover:text-blue-500 cursor-pointer flex-shrink-0 bg-slate-100/50 dark:bg-slate-800/40 transition-colors group"
            title="Click to upload & crop article image"
          >
            <Upload className="w-5 h-5 mb-1 group-hover:scale-110 transition-transform text-blue-500" />
            <span className="text-[10px] font-extrabold text-slate-600 dark:text-slate-300">Upload & Crop</span>
          </button>
        )}
        ...
        <div className="flex-1 space-y-1.5 text-xs min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {article.is_poster ? (
              ...
              <span className="text-blue-600 dark:text-blue-400 font-medium truncate max-w-xs">Photo Attached (16:9)</span>
            ) : (
              <span className="text-rose-500 font-medium">No Image Uploaded</span>
            )}
          </div>
          ...
          <div className="flex items-center gap-2 pt-1 flex-wrap">
            <button
              type="button"
              onClick={() => fileInputRef.current?.click()}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-extrabold rounded-md bg-blue-600 hover:bg-blue-700 text-white transition-colors cursor-pointer shadow-xs"
              title="Upload custom image, crop to 16:9 card, and compress to WebP"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1 px-2.5 py-1.5 text-[11px] font-bold rounded-md bg-amber-500 hover:bg-amber-600 text-slate-950 transition-colors"
            >
              🎨 Full Banner
            </button>
            <button
              ...
              className="inline-flex items-center gap-1 px-2.5 py-1.5 text-[11px] font-bold rounded-md bg-indigo-600 hover:bg-indigo-700 text-white transition-colors"
            >
              🖼️ Square Box
            </button>
            <button
              ...
              disabled={loadingAi}
              className="inline-flex items-center gap-1 px-2.5 py-1.5 text-[11px] font-bold rounded-md bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 transition-colors disabled:opacity-50"
            >
              {loadingAi ? (
        ...
        <TnTodayImageCropModal
          ...
          articleSlug={article.slug || "tn-today-import"}
        />
      </div>
