    ...
    return (
      <div className="relative inline-block text-left z-30">
        ...
        <AnimatePresence>
          {open && (
            <>
              {/* Click-outside transparent backdrop overlay */}
              <div
              ...
              <motion.div
                ...
                className="absolute bottom-full right-0 mb-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-2xl p-3 z-[100] min-w-[210px]"
              >
                <p className="text-xs font-semibold text-slate-400 uppercase tracking-wide mb-2">Share Report</p>
                <div className="space-y-1">
                  ...
                  <button
                    onClick={copyLink}
                    type="button"
                    className="flex items-center gap-2.5 px-3 py-2 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors w-full text-left"
                  >
