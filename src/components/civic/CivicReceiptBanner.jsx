    ...
    <div className="flex gap-3 p-4 rounded-2xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700">
      ...
      <div>
        ...
        <p className="text-xs text-blue-700 dark:text-blue-300 leading-relaxed">
          {T(
            "NammaTN is not a government office. Your post creates a public Civic Receipt — a transparent proof trail that helps citizens document, verify, route, track, and prove local issues.",
            "NammaTN ஒரு அரசு அலுவலகம் அல்ல. உங்கள் பதிவு ஒரு பொது குடிமை ரசீதை உருவாக்குகிறது — இது குடிமக்கள் உள்ளூர் சிக்கல்களை ஆவணப்படுத்த, சரிபார்க்க, கண்காணிக்க உதவுகிறது."
          )}
        </p>
