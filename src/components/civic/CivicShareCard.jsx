...
function getContextShareText(post, url) {
  ...
  switch (post.civic_status) {
    case "reported":
      return `📋 New civic issue documented in ${location}.\n\n"${post.title_en}"\n\nHelp verify — if you've seen this issue, confirm it on NammaTN.${base}`;
    ...
    default:
      return `📋 NammaTN Civic Receipt: ${post.civic_receipt_id}\n"${post.title_en}"\n📍 ${location}\n📅 ${daysOpen} days open · ${vCount} verified${base}`;
  }
}
    ...
    <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl overflow-hidden">
      ...
      <div className="px-5 pb-3 space-y-3">
        ...
        <div className="border-t border-slate-700 pt-3 flex items-center justify-between">
          <div>
            <p className="text-xs text-slate-300 font-semibold">{T("Track on NammaTN", "NammaTN-ல் கண்காணிக்கவும்")}</p>
