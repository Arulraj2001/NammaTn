      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="mt-6 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800 rounded-2xl p-5 text-center">
          ...
          <p className="text-xs text-blue-600 dark:text-blue-400 max-w-lg mx-auto">
            {T("All data is anonymized and aggregated from public civic reports. NammaTN never sells personal data. Leaderboards exist to celebrate community action, not individual identity.", "அனைத்து தரவும் பொது குடிமை அறிக்கைகளிலிருந்து அநாமதேயமாக்கப்பட்டுள்ளது.")}
          </p>
        </div>
      </div>
    </div>
