...
export default function Situations() {
  ...
  usePageMeta({ title: "NammaTN - Live Situations", description: "Follow urgent local situations, emergency updates, active alerts, and real-time public reports from Tamil Nadu areas." });
