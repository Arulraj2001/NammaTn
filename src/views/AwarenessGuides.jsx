...
const ALL_GUIDES = [
  {
    ...
    steps_en: [
      ...
      "Raise it on NammaTN so your neighbours can upvote and escalate together.",
    ],
    steps_ta: [
      ...
      "NammaTN இல் பதிவிட்டு அண்டை வீட்டினரையும் இணைக்கவும்.",
    ],
  ...
  },
  {
    ...
    steps_en: [
      ...
      "Also report on NammaTN — community exposure helps.",
    ],
    steps_ta: [
      ...
      "NammaTN இலும் பதிவிடுங்கள் — சமூக அழுத்தம் பயனுள்ளது.",
    ],
...
export default function AwarenessGuidesPage() {
  ...
  usePageMeta({
    title: "Citizen Guides — What To Do | NammaTN",
