              ...
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-700 dark:text-amber-400 mt-1 leading-relaxed">
                    {T(
                      "VizhiTN is not a government portal. Your post creates a public Civic Receipt. We help citizens document, verify, route, track, and prove local issues. VizhiTN cannot guarantee government action.",
                      "VizhiTN ஒரு அரசு போர்ட்டல் அல்ல. உங்கள் பதிவு ஒரு பொது குடிமை ரசீதை உருவாக்குகிறது. உள்ளூர் சிக்கல்களை ஆவணப்படுத்தவும், சரிபார்க்கவும், கண்காணிக்கவும் குடிமக்களுக்கு நாங்கள் உதவுகிறோம்."
                    )}
                  </p>
                </div>
              </label>
