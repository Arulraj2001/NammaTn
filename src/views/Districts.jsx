      ...
      >
        {filtered.map((d) => (
          <motion.div key={d.slug} variants={{ hidden: { opacity: 0, scale: 0.95 }, visible: { opacity: 1, scale: 1 } }}>
            <Link to={`/${d.slug}`}>
              <div className="bg-white dark:bg-slate-800 border-2 border-slate-300 dark:border-slate-700 rounded-2xl p-4 hover:shadow-md hover:border-blue-500 dark:hover:border-blue-500 hover:-translate-y-1 transition-all duration-200 text-center group">
