...
export default function Contact() {
  ...
  usePageMeta({
    title: "Contact | NammaTN234",
    description: "Contact the NammaTN234 team for support, feedback, or platform queries.",
  });
  ...
  const TOPICS = [
    ...
    { icon: Mail, color: "bg-purple-100 text-purple-600 dark:bg-purple-900/30 dark:text-purple-400", en: "Advertising", ta: "விளம்பரம்", en_desc: "Interested in advertising on NammaTN234.", ta_desc: "NammaTN234 இல் விளம்பரம் செய்ய விரும்புகிறேன்." },
  ];
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-3">
          {T("Contact NammaTN234", "NammaTN234 ஐ தொடர்பு கொள்ளுங்கள்")}
        </h1>
