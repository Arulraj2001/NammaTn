...
const ADVANCED_FIELDS = [
  {
    group: "🔍 Core Meta",
    fields: [
      { key: "seo_meta_keywords", label: "Meta Keywords (comma-separated)", placeholder: "Tamil Nadu, civic, community, VizhiTN", type: "text" },
      { key: "seo_author", label: "Site Author / Publisher Name", placeholder: "VizhiTN Team" },
      { key: "seo_copyright", label: "Copyright Text", placeholder: "© 2025 VizhiTN. All rights reserved." },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "seo_og_site_name", label: "OG Site Name", placeholder: "VizhiTN" },
      { key: "seo_og_locale", label: "OG Locale", placeholder: "en_IN" },
      { key: "seo_og_locale_alt", label: "OG Alternate Locale", placeholder: "ta_IN" },
      { key: "seo_twitter_site", label: "Twitter @Site Handle", placeholder: "@VizhiTNofficial" },
      { key: "seo_twitter_creator", label: "Twitter @Creator Handle", placeholder: "@VizhiTN" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "seo_apple_touch_icon", label: "Apple Touch Icon URL", placeholder: "https://vizhitn.in/apple-touch-icon.png" },
...
const STRUCTURED_DATA_FIELDS = [
  { key: "sd_org_name", label: "Organization Name", placeholder: "VizhiTN" },
  { key: "sd_org_url", label: "Organization URL", placeholder: "https://vizhitn.in" },
  { key: "sd_org_logo", label: "Organization Logo URL", placeholder: "https://vizhitn.in/logo.png" },
  { key: "sd_org_phone", label: "Contact Phone", placeholder: "+91 XXXXX XXXXX" },
  { key: "sd_org_email", label: "Contact Email", placeholder: "hello@vizhitn.in" },
  { key: "sd_social_profiles", label: "Social Profile URLs (one per line)", placeholder: "https://twitter.com/VizhiTN\nhttps://facebook.com/VizhiTN", multiline: true },
  ...
  { key: "sd_article_publisher", label: "Article Publisher URL", placeholder: "https://vizhitn.in" },
];
      ...
      {activeTab === "hreflang" && (
        <div className="space-y-4">
              ...
              {HREFLANG_LOCALES.map((locale) => (
                <div key={locale.code}>
                  ...
                  <Input
                    ...
                    placeholder={`https://vizhitn.in${locale.code === "ta-IN" ? "/ta" : locale.code === "hi-IN" ? "/hi" : "/"}`}
                    className="text-sm"
                  />
                </div>
              ))}
          ...
          <SectionCard title="🔗 Canonical & Language Meta">
            <div className="space-y-3">
              {[
                { key: "seo_canonical_base", label: "Canonical Base URL", placeholder: "https://vizhitn.in" },
...
{JSON.stringify({
  ...
  "@type": "Organization",
  name: val("sd_org_name") || "VizhiTN",
  url: val("sd_org_url") || "https://vizhitn.in",
      ...
      {activeTab === "robots" && (
        <div className="space-y-4">
          <SectionCard title="🤖 Robots.txt Configuration">
            <div className="space-y-3">
              {[
                ...
                { key: "robots_sitemap_url", label: "Sitemap URL", placeholder: "https://vizhitn.in/sitemap.xml" },
              ].map((f) => (
                <div key={f.key}>
                  <label className="text-xs font-medium text-slate-600 dark:text-slate-300 mb-1 block">{f.label}</label>
                  {f.multiline ? (
          ...
          <SectionCard title="🗺️ Sitemap Settings">
            <div className="space-y-3">
              {[
                { key: "sitemap_base_url", label: "Sitemap Base URL", placeholder: "https://vizhitn.in" },
